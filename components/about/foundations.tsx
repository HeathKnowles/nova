    ...
    <section className="bg-[#353535] py-24 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="md:p-12 relative">
          ...
          {/* Bottom Scroller */}
<div className="mt-16 pt-12 border-t border-[#808080] flex items-center gap-4">

  {/* Left Arrow */}
  <button
    onClick={slideLeft}
    disabled={idx === 0}
    className="shrink-0 p-2 rounded-full border border-gray-700 text-gray-500 hover:text-white hover:border-gray-500 transition disabled:opacity-40"
  >
    <ArrowLeft size={20} />
  </button>
  ...
  <div className="overflow-hidden flex-1">
    <div
      className="flex transition-transform duration-500 ease-out uppercase text-gray-500 tracking-widest text-center text-xs sm:text-sm"
      style={{
