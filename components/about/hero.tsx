  ...
  return (
    <section className="bg-[#FFFBF8] py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="flex flex-col lg:flex-row mb-16 items-center lg:items-start gap-8 text-center lg:text-left">
          
          <h1 className="text-[40px] sm:text-[48px] lg:text-6xl font-bold text-[#6D4C71]">
            About Nova
          </h1>

            <p className="text-base sm:text-lg text-[#6D4C71] max-w-2xl">
